...
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
    {
        ...
        {
            Title = $"Empresa {ServicesHelper.GetServiceName()} API ",
            Version = description.ApiVersion.ToString(),
            Description = "API AUTENTICAÇÃO",
            Contact = new OpenApiContact() { Name = "Direto ao ponto", Email = "suporte@diretoaoponto.com.br" },
            License = new OpenApiLicense() { Name = "GPL", Url = new Uri("https://teste.com.br/") }
